# CODSOFT SEPTEMBER 2023 ML TASK 1 - Credit Card Fraud Detection
...
10. **Split data back into training and test datasets**: Split the combined data back into training and test datasets.6+555
